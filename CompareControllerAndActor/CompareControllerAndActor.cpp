...
int main(int argc, char* argv[])
{
	...
	RLSimion::g_pExperiment = new CExperiment(pActorParameters->getChild("EXPERIMENT"));
	RLSimion::g_pWorld = new CWorld(pActorParameters->getChild("World"));
	...
	CAction *a2= RLSimion::g_pWorld->getActionInstance();
