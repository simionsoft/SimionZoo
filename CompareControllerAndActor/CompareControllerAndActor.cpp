...
CExperiment *RLSimion::Experiment = 0;
...
int main(int argc, char* argv[])
{
	...
	RLSimion::Experiment = new CExperiment(pActorParameters->getChild("EXPERIMENT"));
	RLSimion::World = new CWorld(pActorParameters->getChild("World"));
	...
	CState *s= RLSimion::World.getStateInstance();
	CAction *a= RLSimion::World.getActionInstance();
	CAction *a2= RLSimion::World.getActionInstance();
