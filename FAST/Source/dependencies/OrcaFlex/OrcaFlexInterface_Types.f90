...
! This module contains all of the user-defined types needed in OrcaFlexInterface. It also contains copy, destroy, pack, and
...
! 
   ErrStat = ErrID_None
   ErrMsg  = ""
    DstOtherStateData%PtfmAM = SrcOtherStateData%PtfmAM
...
ENDIF
    DstOtherStateData%LastTimeStep = SrcOtherStateData%LastTimeStep
