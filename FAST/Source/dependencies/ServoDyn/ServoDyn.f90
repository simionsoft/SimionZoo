...
MODULE ServoDyn
   ...
   TYPE(ProgDesc), PARAMETER            :: SrvD_Ver = ProgDesc( 'ServoDyn', 'v1.03.01a-bjj', '5-Oct-2015' )
...
! ===================================================================================================
! This code was generated by Write_ChckOutLst.m at 02-Mar-2015 10:36:52.
   ...
   INTEGER(IntKi), PARAMETER      :: MaxOutPts = 11
...
!..................................................................................................................................
   ...
   IF (p%CompNTMD) THEN
      ...
      TMD_InitInp%RootName  = p%RootName
      ...
      IF (.NOT. EqualRealNos( Interval, p%DT ) ) THEN
         CALL CheckError( ErrID_Fatal, "TMD time step differs from SrvD time step." )
         RETURN
      END IF      
...
!      using the parameters listed in the "OutListParameters.xlsx" Excel file. Any changes to these 
!      lines should be modified in the Matlab script and/or Excel worksheet as necessary. 
! This code was generated by Write_ChckOutLst.m at 02-Mar-2015 10:27:13.
!----------------------------------------------------------------------------------------------------------------------------------
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(12) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "NTMD_XQD ","NTMD_YQ  ","NTMD_YQD ","YAWMOM   ","YAWMOMCOM"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(12) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                BlPitchC1 , BlPitchC2 , BlPitchC3 ,    GenPwr ,     GenTq ,  HSSBrTqC ,   NTMD_XQ , &
                                 NTMD_XQD ,   NTMD_YQ ,  NTMD_YQD , YawMomCom , YawMomCom /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(12) =  (/ &                     ! This lists the units corresponding to the allowed parameters
   ...
   IF ( ErrStat /= 0_IntKi )  THEN
      ErrStat = ErrID_Fatal
      ErrMsg  = "SetOutParam:Error allocating memory for the ServoDyn OutParam array."
      RETURN
   ELSE
      ErrStat = ErrID_None
   ENDIF
