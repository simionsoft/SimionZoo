...
CIncrementalNaturalActorCritic::CIncrementalNaturalActorCritic(CParameters* pParameters)
...
double CIncrementalNaturalActorCritic::updateValue(CState *s, CAction *a, CState *s_p, double r, double rho)
{
